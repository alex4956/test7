...
filemenu.add_command(label="6. Вывод всех записей из таблицы str_articles в текстовый файл", command=print_records_1)
filemenu.add_separator()
filemenu.add_command(label="7. Удаление всех записей из таблицы str_articles в БД PostgreSQL", command=delete_records_1)
filemenu.add_command(label="8. Удаление таблицы str_articles из БД PostgreSQL", command=delete_table_1)
filemenu.add_separator()
filemenu.add_command(label="Выход", command=root.quit)

helpmenu = Menu(mainmenu, tearoff=0)
helpmenu.add_command(label="1. Этот пункт пропускаем для БД Sqlite3")
...
helpmenu.add_command(label="6. Вывод всех записей из таблицы str_articles в текстовый файл", command=print_records_3)
helpmenu.add_separator()
helpmenu.add_command(label="7. Удаление всех записей из таблицы str_articles в БД Sqlite3", command=delete_records_3)
...
testmenu.add_separator()
testmenu.add_command(label="Тест read_login()", command=read_login)
